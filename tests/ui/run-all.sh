...
cd "$(dirname "$0")"
fail=0; pass=0
for f in flow0-slow-login flow1-inbound flow1b-orders flow1c-external flow2-container flow3-wave flow4-rm flow5-transfer flow6-palletchange flow7-dispatch flow8-external flow9-edit; do
  echo "===== $f ====="
