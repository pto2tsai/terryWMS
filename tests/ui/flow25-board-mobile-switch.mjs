...
H.check('沒有調度工單時顯示「✅ 目前沒有調度工單」', (await txt('l-dispatch')).includes('目前沒有調度工單'));
...
H.check('即時更新：新調度工單出現、上架完成的任務消失（沒有重新整理）', (await txt('c-dispatch')) === '1' && (await txt('c-tasks')) === '1', JSON.stringify([await txt('c-dispatch'), await txt('c-tasks')]));
